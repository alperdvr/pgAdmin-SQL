...
/*1- CREATE TABLE IF NOT EXISTS, tablonun var olup olmadığını kontrol eder. 
Eğer tablo zaten mevcutsa, CREATE TABLE komutu hiçbir şey yapmaz. 
Yani, PostgreSQL herhangi bir hata vermeden ve tabloyu yeniden oluşturmadan komutu yoksayar.
...
--INSERT INTO programmers(name, email, salary, prog_lang) VALUES('Jerry', 'mail@gmail.com', 5000, 'Python'); --HATA

INSERT INTO programmers(name, email, salary, prog_lang) VALUES('Jerry', 'jerry@gmail.com', 5000, 'Python');
...
INSERT INTO programmers(email, salary, prog_lang) VALUES('python01@gmail.com', 4000, 'Python');
...
INSERT INTO programmers1(name, email, salary, prog_lang) VALUES('Jerry', 'jerry@gmail.com', 5000, 'Python');

--INSERT INTO programmers1(email, salary, prog_lang) VALUES('python01@gmail.com', 4000, 'Python'); --HATA
...
INSERT INTO person VALUES(11,'Ali Can',6000,-3); --person_age_check, HATA
INSERT INTO person VALUES(11,'Ali Can',4000,45); --person_salary_check, HATA
