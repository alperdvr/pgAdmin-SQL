...
-------
SELECT CONCAT(isim,' ',soyisim) AS isim_soyisim, LENGTH(CONCAT(isim, soyisim)) AS karakter_sayisi
FROM person
...
SELECT urun_adi, COUNT(DISTINCT isim) AS toplam_kisi_sayisi
FROM greengrocer
GROUP BY urun_adi;
...
------------------
--30-HAVING ifadesi
--where kayitlari filtreler, 
--having ise sonuclari
