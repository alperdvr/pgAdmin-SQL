...
id_film int,
	CONSTRAINT fk FOREIGN key(id_film) REFERENCES filmler(film_id) on delete cascade
);
...
delete from aktorler where id_film=1;

delete from filmler;--tüm tabloyu silmek için öncelikle childi temizledik
TRUNCATE table filmler;

delete from aktorler;
